...
public class JasminTest {
    ...
    JasminUtils.testJmm("fixtures/public/WhileAndIF.jmm", JasminUtils.getResource("fixtures/public/WhileAndIF.txt"));
	  ...
	  @Test
    public void testMrMeeseeks() {
        JasminUtils.testJmm("fixtures/public/created_tests/MrMeeseeks.jmm", "Result: 13");
    }
    @Test
    public void testRandom() {
        JasminUtils.testJmm("fixtures/public/created_tests/Random.jmm", "Result: 6");
    }
    @Test
    public void testArray() {
        JasminUtils.testJmm("fixtures/public/created_tests/Array.jmm", "Result: 6");
    }
